...
public class PlayerLoggerUtil {
    ...
    public static void setup(Player player, LogHandler.LogType logType) {
    ...
    public static FileConfiguration get(LogHandler.LogType type, Player p) {
    ...
    public static void save(LogHandler.LogType type, Player p) {
